...
SECRET_KEY = config('SECRET_KEY', default='chave-super-secreta', cast=str)
...
LANGUAGE_CODE = config('APP_LOCALE', default='pt-br', cast=str)

TIME_ZONE = config('APP_TIMEZONE', default='America/Sao_Paulo', cast=str)
